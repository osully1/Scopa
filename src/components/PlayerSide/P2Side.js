...
const P2Side = (props) => {
    ...
    return(
        <>
            <p className={css([stylesb.ScoreInactive, props.gameOn === true && stylesb.ScoreActive, props.gameOn === true && props.p2Wins === true && stylesb.ScoreWon])}>Player 2: {props.p2Score}</p>
